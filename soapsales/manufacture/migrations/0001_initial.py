    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('description', models.TextField()),
                ('type', models.PositiveSmallIntegerField(choices=[('DONT-CHOOSE-ME', 'Do Not Choose Me'), (0, 'Product'), (1, 'By-Product'), (2, 'Co-Product'), (3, 'Waste')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unit_time', models.PositiveSmallIntegerField(choices=[('DONT-CHOOSE-ME', 'Do Not Choose Me'), (0, 'per second'), (1, 'per minute'), (2, 'per hour')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.PositiveSmallIntegerField(choices=[('DONT-CHOOSE-ME', 'Do Not Choose Me'), (0, 'Raw Material'), (1, 'Process Product')])),
                ('quantity', models.FloatField()),
