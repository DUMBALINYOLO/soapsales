    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payroll_taxes', models.ManyToManyField(blank=True, to='employees.PayrollTax')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payroll_officer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payroll_officer', to='employees.PayrollOfficer')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference_number', models.CharField(default=None, max_length=255, null=True)),
                ('authorized_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='authority', to='employees.Employee')),
                ('employee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employee_name', to='employees.Employee')),
            ],
        ),
        migrations.AddField(
