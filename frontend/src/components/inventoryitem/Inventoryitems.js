    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.inventoryitems}
                    style={{backgroundColor: '#4EB08E'}}
                    header={header} responsive className="table-head" dataKey="id" rowHover globalFilter={this.state.globalFilter}
                    selection={this.state.selectedInventoryitems} onSelectionChange={e => this.setState({selectedInventoryitems: e.value})}
                    ...
                    <Column className="table-field" field="category" header="Category" sortable filter filterPlaceholder="Search by Category" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
...
export default connect(mapStateToProps, {getInventoryitems} ) (Inventoryitems);
