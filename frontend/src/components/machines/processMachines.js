        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.processmachines}
                    ...
                    <Column className="table-field" field="machine_group" header="Machine Groups" sortable filter filterPlaceholder="Search by Machine Group" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
