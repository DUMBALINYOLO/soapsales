...
import { getAccountingConfig} from '..//../actions/accountingConfig';
import "./form.css";
    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.accountingConfig}
                    ...
                    <Column field="start_of_financial_year" header="Openning Period" sortable filter filterPlaceholder="Search by Date" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="defaul_accounting_period" header="Accounting Period" sortable filter filterPlaceholder="Search by Accounting Period" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="default_bookkeeper" header="Default-Bookkeeper" sortable filter filterPlaceholder="Search by Default-Bookkeeper" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="equipment_capitalization_limit" header="Equipment Limit" sortable filter filterPlaceholder="Search by Equipment-Capitalization-Limit" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
...
export default connect(mapStateToProps, {getAccountingConfig} ) (AccountingConfig);
