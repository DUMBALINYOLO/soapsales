        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.bills}
                    ...
                    selection={this.state.selectedBills} onSelectionChange={e => this.setState({selectedBills: e.value})}
                    ...
                    <Column
                        ...
                        filterElement={dateFilter} style={{width:'3em', backgroundColor: '#4EB0A5'}}
                    />
                    <Column
                        className="table-field"
                        field="vendor"
                    ...
                    <Column
                        ...
                        field="memo"
                        header="Memo"
                        sortable filter filterPlaceholder="Search by Memo"
                        style={{width:'3em', backgroundColor: '#4EB0A5'}}
                    />
                    <Column
                        className="table-field"
