    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.pricinggroups}
                    style={{backgroundColor: '#4EB08E'}}
                    header={header} responsive className="table-head" dataKey="id" rowHover globalFilter={this.state.globalFilter}
                    selection={this.state.selectedPricinggroups} onSelectionChange={e => this.setState({selectedPricinggroups: e.value})}
                    ...
                    <Column className="table-field" field="group_pricing_unit_sales_price" header="Sales Unit" sortable filter filterPlaceholder="Search by Sales Unit" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
...
export default connect(mapStateToProps, {getPricinggroups} ) (Pricinggroup);
