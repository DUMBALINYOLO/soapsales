        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.pricinggroups}
                    ...
                    <Column field="group_pricing_unit_sales_price" header="Sales Unit" sortable filter filterPlaceholder="Search by Sales Unit" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
