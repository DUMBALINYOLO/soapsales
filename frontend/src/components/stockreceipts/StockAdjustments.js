        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.stockadjustments}
                    ...
                    selection={this.state.StockAdjustments} onSelectionChange={e => this.setState({StockAdjustments: e.value})}
                    ...
                    <Column className="table-field" field="adjustment_value" header="Adjustment Value" sortable filter filterPlaceholder="Search by Adjustment Value" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="prev_quantity" header="Prev Quantity" sortable filter filterPlaceholder="Search by Prev Quantity" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
