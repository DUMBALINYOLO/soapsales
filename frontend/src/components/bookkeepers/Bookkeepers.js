        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.bookkeepers}
                    ...
                    <Column field="employee" header="Employee" sortable filter filterPlaceholder="Search by Employee" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="can_create_journals" header="Can Create Journals" sortable filter filterPlaceholder="Search by Can Create Journals" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="can_create_orders_and_invoices" header="Can Create Orders and Invoices" sortable filter filterPlaceholder="Search by orders and invoices" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="can_record_expenses" header="Can Record Expenses" sortable filter filterPlaceholder="Search by Expenses" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="can_record_assets" header="Can Record Assets" sortable filter filterPlaceholder="Search by Assets" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
