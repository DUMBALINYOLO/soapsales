...
class Inventorycontroller extends Component {
    ...
    constructor() {
        super();
        this.state = {
            inventorycontrollers : null,
            globalFilter: null,
            dateFilter: null,
            selectedInventorycontrollers: null,
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>List Of Inventory Controllers</h1>
    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.inventorycontrollers}
                    style={{backgroundColor: '#4EB08E'}}
                    header={header} responsive className="table-head" dataKey="id" rowHover globalFilter={this.state.globalFilter}
                    selection={this.state.selectedInventorycontrollers} onSelectionChange={e => this.setState({selectedInventorycontrollers: e.value})}
                    ...
                    <Column className="table-field" field="can_authorize_equipment_requisitions" header="Equipment Requisitions" sortable filter filterPlaceholder="Search by Equipment Requisition" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="can_authorize_consumable_requisitions" header="Consumable Requisitions" sortable filter filterPlaceholder="Search by Consumable Requisition" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
...
export default connect(mapStateToProps, {getInventorycontrollers} ) (Inventorycontroller);
