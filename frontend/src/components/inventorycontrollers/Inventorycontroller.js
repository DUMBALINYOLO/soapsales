        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.inventorycontrollers}
                    ...
                    <Column field="can_authorize_equipment_requisitions" header="Equipment Requisitions" sortable filter filterPlaceholder="Search by Equipment Requisition" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="can_authorize_consumable_requisitions" header="Consumable Requisitions" sortable filter filterPlaceholder="Search by Consumable Requisition" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
