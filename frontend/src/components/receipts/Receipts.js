        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.receipts}
                    ...
                    selection={this.state.selectedReceipts} onSelectionChange={e => this.setState({selectedReceipts: e.value})}
                    ...
                    <Column className="table-field" field="sales_rep" header="Sales Rep" sortable filter filterPlaceholder="Search by Sales Rep" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="receipt_number" header="Receipt Number" sortable filter filterPlaceholder="Search by Number" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="amount_paid" header="Amount Paid" sortable filter filterPlaceholder="Search by Amount" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="created_date" header="Date" sortable filter filterPlaceholder="Search by Date" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
