...
class EquipmentComponents extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            globalFilter: null,
            dateFilter: null,
            selectedEquipmentcomponents: null,
    ...
    static propTypes = {
        equipmentcomponents : PropTypes.array.isRequired,
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>List Of Equipment Components</h1>
    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.equipmentcomponents}
                    style={{backgroundColor: '#4EB08E'}}
                    header={header} responsive className="table-head" dataKey="id" rowHover globalFilter={this.state.globalFilter}
                    selection={this.state.selectedEquipmentcomponents} onSelectionChange={e => this.setState({selectedEquipmentcomponents: e.value})}
                    ...
                    <Column className="table-field" field="condition" header="Condition" sortable filter filterPlaceholder="Search by Condition" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
...
export default connect(mapStateToProps, {getEquipmentComponents} ) (EquipmentComponents);
