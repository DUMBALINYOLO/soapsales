        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.debitnotes}
                    ...
                    selection={this.state.selectedDebitnotes} onSelectionChange={e => this.setState({selectedDebitnotes: e.value})}
                    ...
                    <Column className="table-field" field="entry" header="Entry" sortable filter filterPlaceholder="Search by Entry" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
