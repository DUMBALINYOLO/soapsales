        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.quotations}
                    ...
                    selection={this.state.selectedQuotations} onSelectionChange={e => this.setState({selectedQuotations: e.value})}
                    ...
                    <Column
                        ...
                        sortable filter filterPlaceholder="Search by Inovice Number"
                        style={{width:'3em', backgroundColor: '#4EB0A5'}}
                    />
                    <Column
                        className="table-field"
                    ...
                    <Column
                        ...
                        header="Order Number"
                        sortable filter filterPlaceholder="Search by Order Number"
                        style={{width:'3em', backgroundColor: '#4EB0A5'}}
                    />
                    <Column
                        className="table-field"
