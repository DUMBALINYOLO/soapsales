        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.wasteReports}
                    ...
                    <Column field="product" header="Product" sortable filter filterPlaceholder="Search by Product" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    ...
                    <Column field="recorded_by" header="Recorded By" sortable filter filterPlaceholder="Search by Record" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="comments" header="Comments" sortable filter filterPlaceholder="Search by Comments" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
