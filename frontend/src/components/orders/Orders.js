        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.orders}
                    ...
                    <Column field="received_to_date" header="Received Date" sortable filter filterMatchMode="custom" filterFunction={this.filterDate} filterElement={dateFilter} style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="status" header="Status" sortable filter filterPlaceholder="Search by Status" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="supplier" header="Supplier" sortable filter filterPlaceholder="Search by Supplier" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="tracker_number" header="Tracker Number" sortable filter filterPlaceholder="Search by Tracker Number" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
