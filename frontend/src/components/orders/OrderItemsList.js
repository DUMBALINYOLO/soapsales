        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.orderitems}
                    ...
                    selection={this.state.selectedOrderItems} onSelectionChange={e => this.setState({selectedOrderItems: e.value})}
                    ...
                    <Column className="table-field" field="order_price" header="Order Price" sortable filter filterPlaceholder="Search by Order Price" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="received_total" header="Received Total" sortable filter filterPlaceholder="Search by Received Total" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
...
export default connect(mapStateToProps, {getOrderItems} ) (OrderItemsList);
