...
class Productcomponents extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            globalFilter: null,
            dateFilter: null,
            selectedProductcomponents: null,
    ...
    static propTypes = {
        productcomponents : PropTypes.array.isRequired,
    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.productcomponents}
                    style={{backgroundColor: '#4EB08E'}}
                    header={header} responsive className="table-head" dataKey="id" rowHover globalFilter={this.state.globalFilter}
                    selection={this.state.selectedProductcomponents} onSelectionChange={e => this.setState({selectedProductcomponents: e.value})}
...
export default connect(mapStateToProps, {getProductcomponents} ) (Productcomponents);
