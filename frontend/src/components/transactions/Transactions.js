    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.transactions}
                    ...
                    selection={this.state.selectedTransactions} onSelectionChange={e => this.setState({selectedTransactions: e.value})}
                    ...
                    <Column field="value" header="Value" sortable filter filterPlaceholder="Search by Value" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="affected_account" header="Affected Account" sortable filter filterPlaceholder="Search by Affected Account" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="journal_entry" header="Journal Entry" sortable filter filterPlaceholder="Search by Entry" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="is_debit" header="Is Debit" sortable filter filterPlaceholder="Search by Debit" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
