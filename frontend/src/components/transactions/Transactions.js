        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.transactions}
                    ...
                    <Column className="table-field" field="affected_account" header="Affected Account" sortable filter filterPlaceholder="Search by Affected Account" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="journal_entry" header="Journal Entry" sortable filter filterPlaceholder="Search by Entry" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="is_debit" header="Is Debit" sortable filter filterPlaceholder="Search by Debit" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
