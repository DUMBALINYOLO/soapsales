        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.warehouses}
                    ...
                    <Column className="table-field" field="inventory_controller" header= "Controller" sortable filter filterPlaceholder="Search by Controller" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="item_count" header="Item Count" sortable filter filterPlaceholder="Search by Item Count" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    <Column className="table-field" field="total_item_quantity" header="Total Item Quantity" sortable filter filterPlaceholder="Search by Quantity" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
