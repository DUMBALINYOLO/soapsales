    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>List Of Inventory Categories</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.inventorycategory}
                    ...
                    <Column className="table-field" field="parent" header="Parent" sortable filter filterPlaceholder="Search by Parent" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
