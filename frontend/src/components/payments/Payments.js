        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.payments}
                    ...
                    selection={this.state.selectedPayments} onSelectionChange={e => this.setState({selectedPayments: e.value})}
                    ...
                    <Column field="invoice" header="Invoice" sortable filter filterPlaceholder="Search by Invoice" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
