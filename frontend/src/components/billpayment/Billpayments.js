        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.billpayments}
                    ...
                    <Column field="account" header="Account" sortable filter filterPlaceholder="Search by Account" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="bill" header="Bill" sortable filter filterPlaceholder="Search by Bill" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
