        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.currencies}
                    ...
                    <Column field="symbol" header="Symbol" sortable filter filterPlaceholder="Search by Symbol" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
...
export default connect(mapStateToProps, {getCurrencies} ) (Currencies);
