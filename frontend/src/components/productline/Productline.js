    ...
    render() {
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.productlines}
                    ...
                    selection={this.state.selectedProductlines} onSelectionChange={e => this.setState({selectedProductlines: e.value})}
                    ...
                    <Column field="product" header="Products" sortable filter filterPlaceholder="Search by Products" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
                    <Column field="unit_price" header="Unit Price" sortable filter filterPlaceholder="Search by Unit Price" style={{width:'3em', backgroundColor: '#4c6b75'}}/>
...
export default connect(mapStateToProps, {getProductlines} ) (Productline);
