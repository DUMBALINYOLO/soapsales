        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.invoices}
                    ...
                    <Column className="table-field" field="invoice_number" header="Invoice Number" sortable filter filterPlaceholder="Search by Inovice Number" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
                    ...
                    <Column className="table-field" field="purchase_order_number" header="Order Number" sortable filter filterPlaceholder="Search by Order Number" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
