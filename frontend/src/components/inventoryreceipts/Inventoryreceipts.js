...
class Inventoryreceipts extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            globalFilter: null,
            dateFilter: null,
            selectedInventoryreceipts: null,
    ...
    renderHeader() {
        return (
            <div className="table-head">
                <h1>List Of Inventory Receipts</h1>
        ...
        return (
            <div className="datatable-doc-demo">
                <DataTable ref={(el) => this.dt = el} value={this.props.inventoryreceipts}
                    ...
                    selection={this.state.selectedInventoryreceipts} onSelectionChange={e => this.setState({selectedInventoryreceipts: e.value})}
                    ...
                    <Column className="table-field" field="received_by" header="Name" sortable filter filterPlaceholder="Search by Name" style={{width:'3em', backgroundColor: '#4EB0A5'}}/>
